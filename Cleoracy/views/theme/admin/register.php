        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?= $router->route("auth.register")?>">
                ...
                <div class="input-group mb-2 tpdivs">
                    ...
                    <div name="materias" style="width: 80%;"  id='Materias'> 
...
<script>
 ...
 $(function () {
    ...
    if(materias != null) {
        ...
        $('#Materias').html('<select class="form-control input_user"> <option value="nada">Nenhuma matéria cadastrada!</option> </select>');
    }
