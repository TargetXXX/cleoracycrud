    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 content">
                ...
                <div class="card">
        <div class="card-body">
            <h5 class="card-title">Cadastrar Materia</h5>
            <form method="POST" action="<?= $router->route("auth.registerMateria")?>">
                <input type="hidden" name="action" value="register">
                <div class="input-group mb-2">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-clipboard"></i></span>
                    </div>
                    <input type="text"  name="name" class="form-control input_user" required placeholder="Nome da matéria">
                </div>
                <div class="input-group mb-2">
                <div class="input-group-append">
