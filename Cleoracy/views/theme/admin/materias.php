...
<body>
    ...
    <!-- Conteúdo principal -->
    <?= flash(); ?>
    <div class="container-fluid" style="max-height: 100vh; overflow: scroll;">
        <div class="row">
            <!-- Sidebar -->
            <div class="col-md-3 sidebar">
                <ul class="nav flex-column">
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Gerenciar Materias</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?=$router->route("admin.mensagens")?>">Gerenciar Mensagens</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?=$router->route("admin.gallery")?>">Gerenciar Galeria</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-9 content">
                ...
                <div class="card">
        <div class="card-body">
            <h5 class="card-title">Gerenciar Materias</h5> <a href="<?=$router->route("admin.registerMaterias")?>" class="btn btn-primary"><i class="fas fa-plus"></i></a>

            <div class="container">
        <?php createMateriasTable();?>
...
function saveMateria(UserId, FormId) {
...
function delMateria(UserId) {
  
      
    var data = {"Id" : UserId};
  
    $.ajax({
      url: "<?= site("root")."/admin/delete/Materia" ?>",
      data: JSON.stringify(data),
      type: "post",
      dataType: "json",
      beforeSend: function () {
