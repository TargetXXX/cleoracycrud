<!DOCTYPE html>
      ...
      <body>
      <header class="p-3 text-white" style="position: absolute; width: 100%;" >
          ...
          <div class="">
            ...
            <ul class="nav ">
              ...
              <li class="nav-item dropdown text-white">
                ...
                <ul class="dropdown-menu">
                <?php if(getSessionUser()->Grupo == 'Aluno') echo '<li><a href='.$router->route("aluno.dashboard").' class="dropdown-item" >Aluno</a></li>' ?>
              <?php if(getSessionUser()->Grupo == 'Admin' || getSessionUser()->Grupo == 'Owner' || getSessionUser()->Grupo == 'Professor') echo '<li><a href='.$router->route("professor.dashboard").' class="dropdown-item" >Professor</a></li> ' ?>
              <?php if(getSessionUser()->Grupo == 'Admin' || getSessionUser()->Grupo == 'Owner') echo '<li><hr class="dropdown-divider"></li> <li><a href='.$router->route("admin.dashboard").' class="dropdown-item" >Admin</a></li>' ?>
                </ul>
              </li>
              <?php    $userAvatar = getSessionUser()->Avatar;      $path = (file_exists(site('root').$userAvatar)) ? site('root').$userAvatar : site('root').defaultImage(); ?>
              
              <div style="position: absolute; right: 2%; width: 50px; height: 50px;"><img  src="<?=site('root').$userAvatar?>" data-toggle="modal" data-target="#editModal" style="cursor: pointer; width: 100%; height: 100%; border-radius: 50%;"></div>
