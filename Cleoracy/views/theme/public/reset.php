<!DOCTYPE html>
        ...
        <head>
            ...
            <link rel="stylesheet" href="http://localhost/cleoracy/views/assets/css/login.css">
            <link rel="stylesheet" href="http://localhost/cleoracy/views/assets/css/message.css">
            ...
            <script src="http://localhost/cleoracy/views/assets/js/form.js"></script>
            <script src="http://localhost/cleoracy/views/assets/js/utils.js"></script>
        </head>
        <body>
