<?php
    ...
    class Admin extends Controller {
        ...
        public function gallery(): void {
            $head = $this->seo->optimize("Tela de admin | ".site("name"), site("desc"), $this->router->route("admin.gallery"), routeImage("Conta de admin"))->render();
        
        
            echo $this->view->render("theme/admin/gallery", [
                "head" => $head,
                "user" => $this->user
            ]);
        }
        ...
        public function mensagens(): void {
            $head = $this->seo->optimize("Tela de admin | ".site("name"), site("desc"), $this->router->route("admin.mensagens"), routeImage("Conta de admin"))->render();
        
        
            echo $this->view->render("theme/admin/mensagens", [
                "head" => $head,
                "user" => $this->user
            ]);
        }
