<?php
    ...
    $router->get("/mensagens", "Admin:mensagens", "admin.mensagens");
    $router->get("/galeria", "Admin:gallery", "admin.gallery");
    ...
    $router->post("/save/Gallery", "AdminAuth:saveGallery", "auth.saveGallery");
    ...
    $router->post("/delete/Message", "AdminAuth:delMessage", "auth.delMessage");
    $router->post("/delete/Gallery", "AdminAuth:delGallery", "auth.delGallery");
